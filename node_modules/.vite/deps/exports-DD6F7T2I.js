...
import {
  ...
  customElement,
  subscribeKey
} from "./chunk-7PXZP6UT.js";
import "./chunk-7TQCR6EQ.js";
import {
  proxy,
  ref,
  subscribe
} from "./chunk-YGDL37CI.js";
import "./chunk-URTOKSJR.js";
...
var Web3ModalSIWEClient = class {
  ...
  async signIn() {
    ...
    const chainId = HelpersUtil.caipNetworkIdToNumber((_a4 = NetworkController.state.caipNetwork) == null ? void 0 : _a4.id);
    if (!chainId) {
...
var SIWEController = {
  ...
  async signOut() {
    ...
    (_a4 = client.onSignOut) == null ? void 0 : _a4.call(client);
  },
  onSignIn(args) {
    var _a4;
    const client = this._getClient();
    (_a4 = client.onSignIn) == null ? void 0 : _a4.call(client, args);
  },
  onSignOut() {
    var _a4;
    const client = this._getClient();
...
var W3mConnectingSiwe = class W3mConnectingSiwe2 extends LitElement {
  constructor() {
    var _a4;
    super(...arguments);
    this.dappImageUrl = (_a4 = OptionsController.state.metadata) == null ? void 0 : _a4.icons;
    this.walletImageUrl = StorageUtil.getConnectedWalletImageUrl();
  }
  firstUpdated() {
    var _a4;
    const visuals = (_a4 = this.shadowRoot) == null ? void 0 : _a4.querySelectorAll("wui-visual-thumbnail");
  ...
  render() {
    ...
    return html`
      <wui-visual-thumbnail
        ...
        .imageSrc=${(_a4 = this.dappImageUrl) == null ? void 0 : _a4[0]}
      ></wui-visual-thumbnail>
...
var W3mConnectingSiweView = class W3mConnectingSiweView2 extends LitElement {
  constructor() {
    var _a4;
    super(...arguments);
    this.dappName = (_a4 = OptionsController.state.metadata) == null ? void 0 : _a4.name;
...
@lit/reactive-element/development/decorators/query-assigned-nodes.js:
   ...
   *)
*/
//# sourceMappingURL=exports-DD6F7T2I.js.map
